...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { auteur: @art.auteur, citation: @art.citation, date: @art.date, dimensions: @art.dimensions, emotion: @art.emotion, photo: @art.photo, titre: @art.titre } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { auteur: @art.auteur, citation: @art.citation, date: @art.date, dimensions: @art.dimensions, emotion: @art.emotion, photo: @art.photo, titre: @art.titre } }
